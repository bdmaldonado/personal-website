  ...
  return (
    <div>
	  ...
	  <p>
	     ...
	     the client hits the website, Nginx is used to serve the user to a Next.js/React framework-based website, which itself runs using <Link legacyBehavior href="https://pm2.keymetrics.io/docs/usage/quick-start/">PM2</Link>, a process daemonizer. All of this is controlled by the 
