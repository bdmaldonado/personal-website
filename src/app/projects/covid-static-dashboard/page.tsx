    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                <Image src="/ohio_dashboard.png" alt="Official Ohio COVID-19 Dashboard" style={{ width: '300px', marginRight: '20px' }} />
                <Image src="/my_static_dashboard.jpg" alt="My Rendition of this Dashboard" style={{ width: '300px' }} />
            </div>
